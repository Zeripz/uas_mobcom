package com.example.uas_mobcom;
...
public class UploadActivity extends AppCompatActivity {
    ...
    public void saveData() {
        if (uri != null) {
            StorageReference storageReference = FirebaseStorage.getInstance().getReference().child("Check1")
            ...
            storageReference.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    // Handle the case where uploading the file fails
                    dialog.dismiss();
    ...
    public void uploadData(){
        ...
        FirebaseDatabase.getInstance().getReference("Check1").child(title)
